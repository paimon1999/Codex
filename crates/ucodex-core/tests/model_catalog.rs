...
async fn model_catalog_uses_active_relay_profile_model_list_for_display() {
    ...
    let previous_settings_path =
        ucodex_core::paths::set_settings_path_for_tests(Some(settings_path.clone()));
    unsafe {
    ...
    ucodex_core::paths::set_settings_path_for_tests(previous_settings_path);
