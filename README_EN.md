...
```text
apps/
  ucodex-launcher/              Silent launcher
  ucodex-manager/               Tauri manager
assets/inject/
  renderer-inject.js            Enhancement script injected into Codex
crates/
  ucodex-core/                  Launch, injection, config, update, install, bridge
  ucodex-data/                  Session data, export, Provider Sync
scripts/installer/
